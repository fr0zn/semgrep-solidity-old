...
(**
    Functions for parsing solidity programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a solidity program from a string into a typed OCaml CST.
...
(** Parse a solidity program from a file into a typed OCaml CST.
